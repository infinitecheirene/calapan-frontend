...
export default function CTASection () {
    return (
        <section className="bg-white shadow-xl py-16 absolute inset-x-0 overflow-hidden z-10">
            <div className="text-center px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-gray-600 text-lg mb-8 max-w-3xl mx-auto">
                    ...
                    <i>
                    Request certificates, permits, and official records online — no long lines, no delays. <br/>Stay updated and complete your transactions in just a few steps.
                    </i>
                </p>
